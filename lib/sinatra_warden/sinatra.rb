  ...
  module Warden
    ...
    def self.registered(app)
      ...
      app.get '/logout/?' do
        ...
        flash[:success] = options.auth_logout_message || options.auth_success_message if defined?(Rack::Flash)
        redirect ( options.auth_logout_path || options.auth_success_path || back )
      end
    end
  end # Warden
